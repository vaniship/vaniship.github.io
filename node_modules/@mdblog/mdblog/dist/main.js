/**
* @mdblog/mdblog v2.0.4
* Copyright © mdblog 2019.
*/

System.register(['vue', 'bootstrap-vue', 'axios', 'blueimp-md5', 'marked', 'he'], function (exports, module) {
  'use strict';
  var Vue$1, BootstrapVue, axios, md5, marked, he;
  return {
    ...
    execute: function () {
      ...
      var resolveMap = [{
        test: /^@mdblog\/mdblog$/,
        path: function path() {
          return 'node_modules/@mdblog/mdblog/dist/main.js';
        }
      }, {
        test: /^@mdblog\/.*/,
      ...
      function () {
        function _default() {
          ...
          renderer.image = function (href, title, text) {
            ...
            var _qs$parse = lib.parse(href.split('?')[1]),
